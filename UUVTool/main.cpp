					   ...
					   _In_ int       nCmdShow)
{
	...
	CPaintManagerUI::SetResourcePath(CPaintManagerUI::GetInstancePath() + _T("Skin\\UUVTool")); // 指定资源路径 
	...
	pMainDlg->Create(NULL, _T("UUVTool"), UI_WNDSTYLE_FRAME/* | WS_MAXIMIZE*/, WS_EX_WINDOWEDGE); // 注册窗口类与创建窗口 
